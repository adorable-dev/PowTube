<!-- not really a 2005 youtube player but ITS WORKING >_< -->
...
<body style="color:white; background-color:black;">
    ...
    <div class="video-stream" style="
        ...
        left: 0px;
    ">
<video id="video-stream" src="../<?= htmlspecialchars($video['video_url']) ?>" onclick="playVid()" style="width:100%; height:100%;"> </video>
...
function exitHandler()
{
 ...
 {
  fullscreen.style.backgroundImage = "assets/fullscreen.png)";
